...
public class _MessageboardServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements VS2.MessageboardServerInterface
{
  ...
  public boolean setMessage (String message, String messageID, int uid, String uName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return setMessage (message, messageID, uid, uName        );
            } finally {
                _releaseReply ($in);
            }
  } // setMessage
  ...
  public VS2.ConnectInformationData connectToFather ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public boolean iterateChilds (String message, String messageID, int uid, String uName, boolean schalter)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("iterateChilds", true);
                $out.write_string (message);
                $out.write_string (messageID);
                $out.write_long (uid);
                $out.write_string (uName);
                ...
                return iterateChilds (message, messageID, uid, uName, schalter        );
            } finally {
                _releaseReply ($in);
            }
  } // iterateChilds
  ...
  public boolean publishOnFather (String message, String messageID, int uid, String uName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return publishOnFather (message, messageID, uid, uName        );
            } finally {
                _releaseReply ($in);
            }
  } // publishOnFather
  ...
  public boolean publishChild (String message, int uid, String uName, boolean schalter)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("publishChild", true);
                $out.write_string (message);
                $out.write_long (uid);
                $out.write_string (uName);
                $out.write_boolean (schalter);
                ...
                return publishChild (message, uid, uName, schalter        );
            } finally {
                _releaseReply ($in);
            }
  } // publishChild
  ...
  public boolean publishFather (String message, int uid, String uName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("publishFather", true);
                $out.write_string (message);
                $out.write_long (uid);
                $out.write_string (uName);
                $in = _invoke ($out);
  ...
  public void saveFatherInformation (int id, String name, VS2.ConnectInformationData ciData)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                saveFatherInformation (id, name, ciData        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void saveChildInformation (int id, String name, VS2.ConnectInformationData ciData)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                saveChildInformation (id, name, ciData        );
            } finally {
                _releaseReply ($in);
            }
