...
/**
* VS2idl/_ClientMessageboardInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from VS2_klein.idl
* Samstag, 28. Januar 2017 02:24 Uhr MEZ
*/

public class _ClientMessageboardInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements VS2idl.ClientMessageboardInterface
{

  public VS2idl.MessageData[] getMessage ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMessage", true);
                $in = _invoke ($out);
                VS2idl.MessageData $result[] = VS2idl.array_of_MessageDataHelper.read ($in);
                return $result;
  ...
  public VS2idl.MessageData getNextMessage ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getNextMessage", true);
                $in = _invoke ($out);
                VS2idl.MessageData $result = VS2idl.MessageDataHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public VS2idl.MessageData getPreviousMessage ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
